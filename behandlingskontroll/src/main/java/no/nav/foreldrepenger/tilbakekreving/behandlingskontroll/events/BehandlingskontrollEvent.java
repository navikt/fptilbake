...
public abstract class BehandlingskontrollEvent implements BehandlingEvent {
    ...
    public static class StartetEvent extends BehandlingskontrollEvent {
        ...
        public StartetEvent(BehandlingskontrollKontekst kontekst, BehandlingModell behandlingModell, BehandlingStegType stegType, BehandlingStegStatus stegStatus) {
    ...
    public static class AvsluttetEvent extends BehandlingskontrollEvent {
        ...
        public AvsluttetEvent(BehandlingskontrollKontekst kontekst, BehandlingModell behandlingModell, BehandlingStegType stegType, BehandlingStegStatus stegStatus) {
            super(kontekst, behandlingModell, stegType, stegStatus);
        }
