...
class BehandlingStegModellImpl implements BehandlingStegModell {
     ...
     */
    BehandlingStegModellImpl(BehandlingModellImpl behandlingModell, Instance<BehandlingSteg> bean, BehandlingStegType stegType) {
            ...
            try {
                ...
                throw new IllegalStateException(
                        "Mangler steg definert for stegKode=" + behandlingStegType + " [behandlingType=" //$NON-NLS-1$ //$NON-NLS-2$
                                + behandlingModell.getBehandlingType() //$NON-NLS-1$ //$NON-NLS-2$
                                + "]",
                        e);
            }
        }
