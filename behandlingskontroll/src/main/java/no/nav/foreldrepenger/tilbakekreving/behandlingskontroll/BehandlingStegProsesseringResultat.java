...
public class BehandlingStegProsesseringResultat {
    ...
    public static BehandlingStegProsesseringResultat medMuligTransisjon(BehandlingStegStatus nyStegStatus, TransisjonIdentifikator transisjon) {
        return new BehandlingStegProsesseringResultat(nyStegStatus, transisjon);
    }

    public static BehandlingStegProsesseringResultat utenOverhopp(BehandlingStegStatus nyStegStatus) {
