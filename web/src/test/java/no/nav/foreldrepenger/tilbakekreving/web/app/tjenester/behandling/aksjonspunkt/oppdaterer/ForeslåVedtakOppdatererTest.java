...
class ForeslåVedtakOppdatererTest {
    ...
    void setup(EntityManager entityManager) {
        ...
        var historikkinnslag2Repository = mock(HistorikkinnslagRepository.class);
        ForeslåVedtakTjeneste foreslåVedtakTjeneste = new ForeslåVedtakTjeneste(beregningsresultatTjenesteMock, historikkinnslag2Repository);
