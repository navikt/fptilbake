...
public class MigrerÅpneBehandlingerTilLosBatchTask implements ProsessTaskHandler {
    ...
    public void doTask(ProsessTaskData prosessTaskData) {
        ...
        gruppe.addNesteParallell(behandlinger.stream().map(MigrerÅpneBehandlingerTilLosBatchTask::opprettTaskForBehandling).toList());
    ...
    private List<Long> finnNesteHundreSaker(Long fraOgMedId) {
        var query = entityManager.createNativeQuery("""
            select behandlingId from (
                ...
                where behandling_id >= :fraId AND AKSJONSPUNKT_STATUS = 'OPPR'
    ...
    private static ProsessTaskData opprettTaskForBehandling(Long behandlingId) {
