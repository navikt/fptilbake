...
public class FpOpenApiUtils {

    private final SwaggerConfiguration swaggerConfiguration;
    private final Application application;

    private FpOpenApiUtils(SwaggerConfiguration swaggerConfiguration, Application application) {
        this.swaggerConfiguration = swaggerConfiguration;
        this.application = application;
    }

    public static FpOpenApiUtils openApiConfigFor(Info info, String contextPath, Application application) {
        var oas = new OpenAPI()
            .openapi("3.1.1")
            .info(info)
        ...
        return new FpOpenApiUtils(swaggerConfiguration, application);
    }

    public FpOpenApiUtils registerClasses(Collection<Class<?>> resourceClasses) {
    ...
    public static void settOppForTypegenereringFrontend() {
        ...
        Set<Class<?>> registeredSubtypes = FPJacksonJsonConfig.getJsonTypeNameClasses();
