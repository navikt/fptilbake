...
class SystemPropertiesHelper {
    ...
    private static final List<String> SECRET_NAME_PARTS = Arrays.asList("passord", "password", "passwd", "private", "key");
    private static final String FILTERED_VALUE = "*****";
    private static final Pattern SECRET_VERDI_REGEX = Pattern.compile("([^= ]*?(?:passord|password|passwd|private|key)[^=]*\\s*=\\s*)[^ ]*", Pattern.CASE_INSENSITIVE);
