...
@Path(TilbakekrevingResultatV2RestTjeneste.PATH_FRAGMENT)
@Produces(APPLICATION_JSON)
@Consumes(APPLICATION_JSON)
@ApplicationScoped
public class TilbakekrevingResultatV2RestTjeneste {
    ...
    public TilbakekrevingResultatV2RestTjeneste() {
        // for CDI
    }

    @Inject
    public TilbakekrevingResultatV2RestTjeneste(BeregningsresultatTjeneste beregningsresultatTjeneste,
