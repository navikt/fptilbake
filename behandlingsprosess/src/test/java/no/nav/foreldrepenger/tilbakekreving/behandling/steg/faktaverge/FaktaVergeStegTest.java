...
class FaktaVergeStegTest extends FellesTestOppsett {
    ...
    void skal_utføre_steg_hvis_verge_aksjonspunkt_finnes() {
        ...
        BehandlingskontrollKontekst kontekst = new BehandlingskontrollKontekst(behandling.getFagsak().getSaksnummer(), behandling.getFagsakId(), behandling.getAktørId(), behandlingLås);
