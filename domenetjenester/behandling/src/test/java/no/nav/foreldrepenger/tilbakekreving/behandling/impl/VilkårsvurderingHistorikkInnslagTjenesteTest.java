...
public class VilkårsvurderingHistorikkInnslagTjenesteTest extends FellesTestOppsett {
    ...
    public void lagHistorikkInnslag_nårForrigePeriodeFinnesIkke() {
        ...
        vilkårsvurderingHistorikkInnslagTjeneste.lagHistorikkInnslag(INTERN_BEHANDLING_ID, null, vurderingEntitet);
    ...
    public void lagHistorikInnslag_medForrigePeriode_medIngenEndringer() {
        ...
        vilkårsvurderingHistorikkInnslagTjeneste.lagHistorikkInnslag(INTERN_BEHANDLING_ID, vurderingEntitet, vurderingEntitet);
    ...
    public void lagHistorikInnslag_medForrigePeriode_medEndringer() {
        ...
        vilkårsvurderingHistorikkInnslagTjeneste.lagHistorikkInnslag(INTERN_BEHANDLING_ID, gammelVurdering, nyVurdering);
        ...
        assertThat(getFraVerdi(førsteDel.getEndretFelt(HistorikkEndretFeltType.MOTTAKER_UAKTSOMHET_GRAD)))
            .isEqualTo(repoProvider.getKodeverkRepository().finn(Aktsomhet.class, Aktsomhet.SIMPEL_UAKTSOM.getKode()).getNavn());
