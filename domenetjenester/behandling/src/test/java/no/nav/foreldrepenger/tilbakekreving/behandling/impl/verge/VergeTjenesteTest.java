...
public class VergeTjenesteTest extends FellesTestOppsett {
    ...
    private BehandlingskontrollTjeneste behandlingskontrollTjeneste = new BehandlingskontrollTjeneste(repoProvider, behandlingModellRepository, eventPublisererMock);
    private VergeTjeneste vergeTjeneste = new VergeTjeneste(behandlingskontrollTjeneste, behandlingskontrollAsynkTjeneste,
        repoProvider);
    private InternalManipulerBehandling manipulerBehandling = new InternalManipulerBehandling(repoProvider);
