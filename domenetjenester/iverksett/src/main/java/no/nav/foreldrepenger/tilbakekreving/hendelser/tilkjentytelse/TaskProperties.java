...
public class TaskProperties {
    ...
    public static final String VARSEL_TEKST = "varselTekst";
    public static final String VARSEL_BELØP = "varselBeloep";
    public static final String TILBAKEKREVING_VALG = "tilbakekrevingValg";
