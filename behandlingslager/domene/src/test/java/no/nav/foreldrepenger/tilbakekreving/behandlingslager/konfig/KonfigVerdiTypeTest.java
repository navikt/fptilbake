package no.nav.foreldrepenger.tilbakekreving.behandlingslager.konfig;
...
public class KonfigVerdiTypeTest {
    ...
    @Test
    public void skal_validere_NULL_verdier() {
        assertThat(KonfigVerdiType.INTEGER_TYPE.erGyldigFormat(null)).isTrue();
        assertThat(KonfigVerdiType.BOOLEAN_TYPE.erGyldigFormat(null)).isTrue();
        assertThat(KonfigVerdiType.STRING_TYPE.erGyldigFormat(null)).isTrue();
        assertThat(KonfigVerdiType.URI_TYPE.erGyldigFormat(null)).isTrue();
        assertThat(KonfigVerdiType.PERIOD_TYPE.erGyldigFormat(null)).isTrue();
        assertThat(KonfigVerdiType.DURATION_TYPE.erGyldigFormat(null)).isTrue();
    }
}
