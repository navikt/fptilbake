...
public class HistorikkEndretFeltVerdiType extends Kodeliste {
    ...
    public static final HistorikkEndretFeltVerdiType GRADERING_OPPFYLT = new HistorikkEndretFeltVerdiType("GRADERING_OPPFYLT");
    public static final HistorikkEndretFeltVerdiType GRADERING_IKKE_OPPFYLT = new HistorikkEndretFeltVerdiType("GRADERING_IKKE_OPPFYLT");
    public static final HistorikkEndretFeltVerdiType ANNEN_FORELDER_HAR_IKKE_RETT = new HistorikkEndretFeltVerdiType("ANNEN_FORELDER_HAR_IKKE_RETT");
    public static final HistorikkEndretFeltVerdiType ANNEN_FORELDER_HAR_RETT = new HistorikkEndretFeltVerdiType("ANNEN_FORELDER_HAR_RETT");
    public static final HistorikkEndretFeltVerdiType GRADERING_PÅ_ANDEL_UTEN_BG_IKKE_SATT_PÅ_VENT = new HistorikkEndretFeltVerdiType("GRADERING_PÅ_ANDEL_UTEN_BG_IKKE_SATT_PÅ_VENT");
