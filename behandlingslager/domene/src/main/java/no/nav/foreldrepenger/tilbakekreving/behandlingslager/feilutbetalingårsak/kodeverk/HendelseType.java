...
public enum HendelseType implements Kodeverdi {
    ...
    ES_FODSELSVILKAARET_TYPE("ES_FODSELSVILKAARET_TYPE", "§ 14-17 første ledd Fødselsvilkåret", 30),
    ES_ADOPSJONSVILKAARET_TYPE("ES_ADOPSJONSVILKAARET_TYPE", "§ 14-17 første ledd Adopsjonsvilkåret", 20),
    ES_FORELDREANSVAR_TYPE("ES_FORELDREANSVAR_TYPE", "§ 14-17 andre ledd Foreldreansvar ", 40),
    ES_OMSORGSVILKAAR_TYPE("ES_OMSORGSVILKAAR_TYPE", "§ 14-17 tredje ledd Omsorgsvilkår ved mors død", 50),
    ES_FORELDREANSVAR_FAR_TYPE("ES_FORELDREANSVAR_FAR_TYPE", "§ 14-17 fjerde ledd Foreldreansvar far", 60),
    ...
    PSB_ANNET_TYPE("PSB_ANNET_TYPE", "Annet", 999),//NOSONAR
