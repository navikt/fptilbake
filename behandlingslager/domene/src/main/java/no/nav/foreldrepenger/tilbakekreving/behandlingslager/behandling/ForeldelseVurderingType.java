...
public enum ForeldelseVurderingType implements Kodeverdi {
    ...
    public static ForeldelseVurderingType fraKode(@JsonProperty(value = "kode") Object node) {
        if (node == null) {
            return null;
        }
        String kode = TempAvledeKode.getVerdi(ForeldelseVurderingType.class, node, "kode");
