...
public class HistorikkinnslagType extends Kodeliste {
    ...
    public static final HistorikkinnslagType NY_KRAVGRUNNLAG_MOTTAT = new HistorikkinnslagType("NY_GRUNNLAG_MOTTATT", MAL_TYPE_6);
    ...
    public static final HistorikkinnslagType FAKTA_OM_FEILUTBETALING = new HistorikkinnslagType("FAKTA_OM_FEILUTBETALING", MAL_TYPE_10);
    public static final HistorikkinnslagType TILBAKEKREVING = new HistorikkinnslagType("TILBAKEKREVING", MAL_TYPE_10);
    public static final HistorikkinnslagType FORELDELSE = new HistorikkinnslagType("FORELDELSE", MAL_TYPE_10);
