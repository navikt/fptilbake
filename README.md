...
* slack-kanal: `#teamforeldrepenger` 
...
Lokalt startes applikasjonene ved å kjøre klassen JettyDevServer med en VM `-Dapp.name` parameter satt til `fptilbake` eller `k9-tilbake`.
