...
public class LosPubliserEventTaskOnPremTest {
    ...
    public void setup(EntityManager entityManager) throws IOException {
        ...
        losPubliserEventTask = new LosPubliserEventTask(repositoryProvider, faktaFeilutbetalingTjeneste, mockKafkaProducer, mockKafkaProducerAiven, Fagsystem.FPTILBAKE, false);
    ...
    public void skal_publisere_fplos_data_til_kafka() throws IOException {
        ...
        verifyNoInteractions(mockKafkaProducerAiven);
        verify(mockKafkaProducer, atLeastOnce()).sendHendelse(any(), any());
