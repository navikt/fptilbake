...
@ApplicationScoped
public class LosKafkaProducerOnPrem {

    private static final Logger log = LoggerFactory.getLogger(LosKafkaProducerOnPrem.class);
    private static final String CALLID_NAME = "Nav-Tbk-CallId";

    private Producer<String, String> producer;
    private String topic;

    LosKafkaProducerOnPrem() {
        // for CDI proxy
    }

    @Inject
    public LosKafkaProducerOnPrem(@KonfigVerdi("kafka.fplos.topic") String topic,
