...
import no.nav.foreldrepenger.tilbakekreving.dokumentbestilling.domene.handlebars.HandlebarsData;
...
class TekstformattererVedtaksbrev {
    ...
    private static final ObjectMapper OM = VedtaksbrevObjectMapper.INSTANCE;

    private TekstformattererVedtaksbrev() {
        // for static access
    }
