...
@ApplicationScoped
public class OnpremSelvbetjeningMeldingProducer {
    ...
    OnpremSelvbetjeningMeldingProducer() {
        // for CDI proxy
    }

    @Inject
    OnpremSelvbetjeningMeldingProducer(@KonfigVerdi("kafka.bootstrap.servers") String bootstrapServers,
                                       @KonfigVerdi("systembruker.username") String username,
                                       @KonfigVerdi("systembruker.password") String password) {
        var topicProd = "privat-tilbakekreving-brukerdialog-p";
