...
import no.nav.foreldrepenger.tilbakekreving.behandlingslager.testutilities.kodeverk.KodeverkTestHelper;
...
public class DokumentArkivTjenesteImplTest {
    ...
    public void skalKorrigereManglendeDokTypeBasertPåTittel() throws Exception {
        ...
        assertThat(dtid).isEqualTo(DokumentTypeId.UDEFINERT);
    }
